...
import io.github.codeblooded.model.Role;
...
public class LoginController {
    ...
    /**
     * Κοινή μέθοδος για την είσοδο στην εφαρμογή.
     * 1. Ενημερώνει το Role στο UserService.
     * 2. Φορτώνει το RootLayout (MainDashboard).
     */
    private void enterApp(Role role) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/io/github/codeblooded/view/RootLayout.fxml"));
            ...
            //CSS
            scene.getStylesheets().add(getClass().getResource("/io/github/codeblooded/style/style.css").toExternalForm());
