public class GreenBudgetTag {
    ...
    private int ministryId; // Χρησιμοποιείται αν το πρόγραμμα είναι κεντρικό Υπουργείο (μπορεί να είναι
                            // NULL)
    private int regionId; // Χρησιμοποιείται αν το πρόγραμμα είναι Αποκεντρωμένη Διοίκηση (μπορεί να είναι
                          // NULL)
